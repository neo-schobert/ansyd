...
import { FaCog, FaFlask, FaSlidersH } from "react-icons/fa";

export default function ConfigMenu({ isDarkMode }: { isDarkMode: boolean }) {
    ...
    <div ref={ref} className="">
      ...
      >
        <MenuItem
          ...
          onClick={() => {
            setOpen(false);
            navigation.push(`/procom/tests?isDarkModeInit=${isDarkMode}`);
          }}
        />
        ...
        {/* <MenuItem
          ...
          onClick={() => {
            setOpen(false);
            navigation.push("/procom/settings");
          }}
        /> */}
      </div>
    </div>
